        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your destination for premium streetwear and urban fashion. 
          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-neutral-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
              />
